...
-- UPDATE HOL_DB1.RETAIL.RETAILER_SALES
-- SET 
--   Market_key = CASE WHEN Market_key = 'US' THEN 'United States' ELSE Market_key END;




-- ALTER TABLE HOL_DB1.RETAIL.RETAILER_SALES
-- DROP COLUMN STORE_KEY, STORE_NUMBER, STORE_CITY, STORE_STATE, STORE_LATITUDE, STORE_LONGITUDE;


-- SELECT * FROM HOL_DB1.RETAIL.RETAILER_SALES LIMIT 1000;
